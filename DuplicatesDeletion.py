...
class duplicates_gui(Frame):
    ...
    def setStartState(self):
        ...
        self._finished_scan = [
            0]  # needs to be a list instead of Boolean, cause it is used as a reference in the threads
        self.update_output()
    ...
    def update_output(self):
        ...
        self._result_total_var.set(
            "The directory contains {0} file(s) which seem to exist twice or more!".format(len(self._duplicates)))
